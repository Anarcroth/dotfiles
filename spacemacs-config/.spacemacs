...
values."
  ...
  (setq-default
   ...
   ;; environment, otherwise it is strongly recommended to le(add-hook 'after-make-frame-functions (lambda (frame) (load-theme 'xresources t)))t it set to t.
...
you should place your code here."
  ...
  ;; override theme with .Xresources config
  (load-theme 'xresources t)
  ;; if this^ stops working for whatever reason, then try with this
...
(custom-set-faces
 ...
 '(spaceline-evil-normal ((t (:background "#1BD4EF" :foreground "#000026" :inherit (quote mode-line)))))
 '(spaceline-evil-replace ((t (:background "#FF511B" :foreground "#504E98" :inherit (quote mode-line)))))
