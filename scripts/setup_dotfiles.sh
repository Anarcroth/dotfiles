...
DP_MONITOR=$(xrandr --query | grep "^DP.* connected" | awk '{ print $1 }')
EDP_MONITOR=$(xrandr --query | grep "^eDP.* connected" | awk '{ print $1 }')
HDMI_MONITOR=$(xrandr --query | grep "^HDMI.* connected" | awk '{ print $1 }')
